...
import replete.bash.evaluation.functions.Associativity;
...
public class FunctionList {
    ...
    static {
        ...
        precedenceMgr.addLevel(Associativity.RIGHT_TO_LEFT, OP_ASSIGN, OP_AASSIGN, OP_SASSIGN, OP_MASSIGN, OP_DASSIGN)  // Level 0
