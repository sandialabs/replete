...
public class RDialog extends JDialog implements RWindow, ChildWindowManager {
    ...
    private ExtChangeNotifier<RWindowClosingListener> attemptToCloseNotifier = new ExtChangeNotifier<RWindowClosingListener>();
    ...
    public RDialog(Dialog owner, String title, boolean modal, ImageIcon icon) {  // New
        super(owner, title, modal);
        init(icon);
    }
    public RDialog(Dialog owner, String title, boolean modal, ImageModelConcept concept) {  // New
        super(owner, title, modal);
    ...
    public RDialog(Frame owner, String title, boolean modal, ImageIcon icon) {  // New
        super(owner, title, modal);
        init(icon);
    }
    public RDialog(Frame owner, String title, boolean modal, ImageModelConcept concept) {  // New
        super(owner, title, modal);
        init(ImageLib.get(concept));
    }
    ...
    public RDialog(Window owner, String title, boolean modal) {  // New
        super(owner, title, modal ? DEFAULT_MODALITY_TYPE : ModalityType.MODELESS);
        init(null);
    }
    public RDialog(Window owner, String title, boolean modal, ImageIcon icon) {  // New
        super(owner, title, modal ? DEFAULT_MODALITY_TYPE : ModalityType.MODELESS);
        init(icon);
    }
    public RDialog(Window owner, String title, boolean modal, ImageModelConcept concept) {  // New
        super(owner, title, modal ? DEFAULT_MODALITY_TYPE : ModalityType.MODELESS);
        init(ImageLib.get(concept));
    }
    public RDialog(Window owner, String title, ModalityType modalityType, GraphicsConfiguration gc) {
    ...
    // debugging features within ANY and EVERY RDialog without the
    // need for visible controls to be provided by the developer
    // of said RDialog.  Debugging features are meant to be able to
