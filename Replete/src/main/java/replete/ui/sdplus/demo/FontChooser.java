...
public class FontChooser extends EscapeDialog {
...
//    setResizable(false);
  ...
  protected void updatePreview() {
    ...
    attrs.put(FAMILY, name);
    attrs.put(SIZE, (float)size);
