...
public class FallingBlocksVisualizerParamsPanel extends VisualizerParamsPanel<FallingBlocksVisualizerParams> {
    ...
    public FallingBlocksVisualizerParamsPanel() {
        super();
    ...
    @Override
    public FallingBlocksVisualizerParams get() {
    ...
    @Override
    public void set(FallingBlocksVisualizerParams params) {
