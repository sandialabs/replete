...
public class FallingBlocksVisualizer extends Visualizer<FallingBlocksVisualizerParams, Void> {
...
//    private TopUrls topUrls;
    ...
    public FallingBlocksVisualizer(FallingBlocksVisualizerParams params, UUID trackedId, FluxPanelContext context) {
