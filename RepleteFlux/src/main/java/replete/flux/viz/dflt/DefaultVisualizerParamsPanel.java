...
public class DefaultVisualizerParamsPanel extends VisualizerParamsPanel<DefaultVisualizerParams> {
    ...
    public DefaultVisualizerParamsPanel() {
        super();
    ...
    @Override
    public DefaultVisualizerParams get() {
    ...
    @Override
    public void set(DefaultVisualizerParams params) {
