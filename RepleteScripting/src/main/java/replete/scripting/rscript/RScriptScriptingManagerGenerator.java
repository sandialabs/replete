...
import replete.scripting.rscript.images.RScriptImageModel;
...
public class RScriptScriptingManagerGenerator extends ScriptingManagerGenerator {
    ...
    public ImageIcon getIcon() {
        return ImageLib.get(RScriptImageModel.RSCRIPT_LOGO);
    }
