...
public class ReflectionDefaultPopulateParamsCreator implements DefaultPopulateParamsCreator {
    ...
    public PopulateParams create() {
        return
            new PopulateParams()
                ...
                .setKeyValueIteratorCreator((KeyValueIteratorCreator) PluginManager.getExtensionById(FieldReflectionKeyValueIteratorCreator.class.getName()))
                ...
                .setKeyValueRegistrar((KeyValueRegistrar) PluginManager.getExtensionById(FieldReflectionKeyValueRegistrar.class.getName()))
                .setNonTerminalExpansionDecider((NonTerminalExpansionDecider) PluginManager.getExtensionById(ReflectionNonTerminalExpansionDecider.class.getName()))
