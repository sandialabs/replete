...
public class SelectSiblingsWorker extends FWorker<Void, Void> {
    ...
    public SelectSiblingsWorker(AppContext ac, WorldContext wc, String name) {
        super(ac, wc, name);
    }
