...
public class AddKeyValuePairLSibAction extends DefaultFinioUiAction {
    ...
    public void register(AppContext ac) {
        ...
        map.createAction("add-list-sib", listener, validator)
            .addDescriptor(
                new MenuBarActionDescriptor()
                    .setPath("change/add")
                    .setText("&List As Sibling")
