...
public class AddKeyValuePairMSibAction extends DefaultFinioUiAction {
    ...
    public void register(AppContext ac) {
        ...
        map.createAction("add-map-sib", listener, validator)
            .addDescriptor(
                new MenuBarActionDescriptor()
                    .setPath("change/add")
                    .setText("&Map As Sibling")
