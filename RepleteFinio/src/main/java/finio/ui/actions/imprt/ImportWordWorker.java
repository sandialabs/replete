...
import finio.extractors.WordExtractor;
...
public class ImportWordWorker extends FWorker<File, NonTerminal> {
    ...
    public ImportWordWorker(AppContext ac, WorldContext wc, String name) {
        super(ac, wc, name);
    }
    ...
    protected File gather() {
        final RFileChooser fc = RFileChooser.getChooser("Select Word File");
        RFilterBuilder builder = new RFilterBuilder(fc, false);
        builder.append("Word Documents (*.docx)", "docx");
    ...
    public String getActionVerb() {
        return "importing Word document";
    }
}
