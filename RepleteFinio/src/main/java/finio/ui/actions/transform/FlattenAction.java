...
public class FlattenAction extends DefaultFinioUiAction {
    ...
    public void register(AppContext ac) {
        ...
        UIActionListener listener = new FWorkerActionListener(ac) {
            ...
            public FWorker create() {
                return new FlattenWorker(ac, ac.getSelectedWorld(), "Flatten");
            }
        };
        ...
        map.createAction("flatten", listener, validator)
            .addDescriptor(
