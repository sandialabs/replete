...
public class ExpandObjectUberAction extends DefaultFinioUiAction {
    ...
    public void register(AppContext ac) {
        ...
        UIActionListener listener = new FWorkerActionListener(ac) {
            ...
            public FWorker create() {
                return new ExpandObjectUberWorker(ac, ac.getSelectedWorld(),
                    "Expand Object (Uber)");
            }
        };
        ...
        map.createAction("expand-pojo-u", listener, validator)
            .addDescriptor(
                new PopupMenuActionDescriptor()
                    .setPath("transform")
                    .setText("Expand Object (Uber)...")
