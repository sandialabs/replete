...
public abstract class AbstractWrapperNonTerminal implements NonTerminal {
    ...
    public AbstractWrapperNonTerminal() {
        // Subclasses required to call subscribe in their constructors
        // after getM() will return the correct non-terminal.
    }
...
//    }
    ...
    // This cannot just return getM().toStringObject().
    @Override
