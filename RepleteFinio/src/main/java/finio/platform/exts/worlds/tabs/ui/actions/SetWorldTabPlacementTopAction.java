...
public class SetWorldTabPlacementTopAction extends DefaultFinioUiAction {
    ...
    public void register(final AppContext ac) {
        ...
        UIActionListener listener = new FWorkerActionListener(ac) {
            ...
            public FWorker create() {
                return new SetWorldTabPlacementWorker(ac, ac.getSelectedWorld(),
                    "World Tabs Top", JTabbedPane.TOP);
            }
        };
        ...
        map.createAction("world-tabs-top", listener, validator)
            .addDescriptor(
                new MenuBarActionDescriptor()
                    .setPath("view")
                    .setOptMenu(true, "world-tabs")
                    .setText("World Tabs Top")
