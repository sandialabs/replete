...
public class FinioPdfParametersPanel extends RPanel {
    ...
    public FinioPdfParametersPanel(XRuleSetHierarchy xhier) {
        ...
        Lay.BLtg(this,
            "N", Lay.BL(
                "C", Lay.lb("<html><u>Parsing</u> <font color='red'>(USING FINIO COMPONENTS)</font></html>",
    ...
    private void doEdit() {
        ...
        if(nSel.get() instanceof NodeRuleSet) {
            ...
            JFrame parent = GuiUtil.fra(FinioPdfParametersPanel.this);
